...
export const yt = {
    // BARU: Tambahkan konstanta untuk menyimpan header browser yang lebih lengkap
    konstanta: {
        baseHeaders: {
            "accept": "*/*",
    ...
    get ytapiHeaders() {
        // MODIFIKASI: Gunakan header dasar yang baru dan tambahkan yang spesifik
        return {
            ...this.konstanta.baseHeaders, // Gunakan semua header browser
