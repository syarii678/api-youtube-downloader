// =================================================================
// PUSTAKA INTI: LOGIKA DOWNLOADER ('yt') - VERSI ANTI-BOT
// =================================================================
...
export const yt = {
    get konstanta() {
        return {
            baseHeaders: {
                ...
                // BARU: Gunakan User-Agent acak setiap kali
    ...
    // ... sisa dari kode yt (validateString, validateFormat, hit, info, dll.) tetap sama ...
    // Salin dan tempel sisa kode dari file downloader.js Anda sebelumnya ke sini
    // Mulai dari validateString hingga akhir.
